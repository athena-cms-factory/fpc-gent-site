                ...
                <div className="flex justify-between items-center h-10">
                    ...
                    <Link to="/" className="flex items-center gap-4 group">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] uppercase font-bold tracking-widest text-blue-500 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">Archive Explorer</span>
                        </div>
                    </Link>
